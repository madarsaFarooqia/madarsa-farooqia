...
export default function EventCard({ event, index = 0 }) {
  ...
  return (
    ...
    >
      <div className="relative aspect-[16/10] overflow-hidden bg-muted">
        ...
        {date && (
          <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm rounded-xl overflow-hidden shadow-sm">
            <div
              className="px-3 py-1 text-white text-[10px] font-jakarta font-bold uppercase tracking-wider text-center"
              style={{ backgroundColor: "var(--deep-oasis)" }}
            >
              {format(date, "MMM")}
            </div>
      ...
      <div className="p-6">
        <span
          className="inline-block text-xs font-jakarta uppercase tracking-[0.15em] mb-2"
